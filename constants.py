...
DB_CREATOR_FEATURE_PATH = "./.db_creator_feature"
...
DB_NAMES = {
    ...
    DB_SHAREHOLDER_BENEFIT_PATH: f"{RAG_TOP_FOLDER_PATH}/shareholder_benefit",
    DB_CREATOR_FEATURE_PATH: f"{RAG_TOP_FOLDER_PATH}/creator_feature"
}
...
SEARCH_SHAREHOLDER_BENEFIT_INFO_TOOL_DESCRIPTION = "株主優待に関する情報を参照したい時に使う"
